...
static void mul_cpx_mainfile( double * a_re, double * a_im, double * b_re, double * b_im, double * c_re, double * c_im  ) ;
...
exit(-1);
	...
	mul_cpx_mainfile(a_re+i,a_im+i, b_re+i,b_im+i,c_re+i, c_im+i);
